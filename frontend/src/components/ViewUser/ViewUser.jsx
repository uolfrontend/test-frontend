        ...
        <div className="line">
            ...
            <div className="mediaDiv status-edit">
                <div>
                    ...
                    <td className='cell'>
                        {user.status === 'Ativo' || user.status === 'active' && (
                            <>
                        ...
                        {user.status === 'Aguardando ativação' || user.status === 'waiting' && (
                            <>
                        ...
                        {user.status === 'Inativo' || user.status === 'inactive' && (
                            <>
                        ...
                        {user.status === 'Desativado' || user.status === 'disabled' && (
                            <>
                ...
                <div>
                    <td className='cell'>
                        <button onClick={handleShowModal} className="btn-custom py-3 px-5"
                            data-toggle="modal">Editar</button> <br></br>
                    </td>
                </div>
